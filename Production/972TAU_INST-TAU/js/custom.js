...
// Add Clickable Logo & Change logo by Language
	app.controller('prmLogoAfterController', ['$location', '$http', function ($location, $http) {
		...
		vm.getLogoLink = function () {
			if (vm.lang === 'he')
				return 'https://tau.primo.exlibrisgroup.com/discovery/search?vid=972TAU_INST:TAU&lang=he';
			else
				return 'https://tau.primo.exlibrisgroup.com/discovery/search?vid=972TAU_INST:TAU&lang=en';
		};
	}]);
